    ...
    getAPI(context) {
      return {
        ...
        ExampleAPI: {
          ...
          // An event. Most of this is boilerplate you don't need to worry about,
          // just copy it.
          onToolbarClick: new ExtensionCommon.EventManager({
            context,
            name: "ExampleAPI.onToolbarClick",
            // In this function we add listeners for any events we want to listen
            // to, and return a function that removes those listeners. To have the
            // event fire in your extension, call fire.async.
            register(fire) {
